...
public final class PathResourceHelper {
    ...
    /**
     * Attempts to resolve the Path of a resource from the curent classpath relative
    ...
    /**
     * Attempts to resolve the Path of a resource from the curent classpath,
     * relative to the calling class. If not found, an IllegalArgumentException will
     * be thrown.
     */
